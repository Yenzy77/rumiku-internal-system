                ...
                <tbody class="divide-y divide-gray-50/50 dark:divide-zinc-800/50">
                    ...
                    <tr class="hover:bg-gray-50/50 dark:hover:bg-zinc-800/50 transition-colors">
                        ...
                        <td class="py-4 px-2 text-center">
                            <button onclick="confirm('Hapus pencatatan ini?') || event.stopImmediatePropagation()" wire:click="delete({{ $item->id }})" class="text-gray-300 dark:text-zinc-600 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 p-2 rounded-xl transition">
