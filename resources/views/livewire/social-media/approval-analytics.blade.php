                    ...
                    <tr class="hover:bg-gray-50/50 dark:hover:bg-zinc-800/50 transition-colors duration-200 group">
                        ...
                        <td class="py-5 px-4">
                            <div class="flex flex-col gap-2 items-center justify-center opacity-70 group-hover:opacity-100 transition-opacity">
                                <button onclick="rumikuConfirm('Setujui post ini untuk tayang sesuai jadwal?', () => @this.approvePost({{ $post->id }}))" class="w-full max-w-[150px] px-4 py-2 bg-white dark:bg-zinc-800 text-blue-600 dark:text-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/20 border border-blue-200 dark:border-blue-900/40 hover:border-blue-400 rounded-2xl text-[11px] font-bold tracking-wide transition-all shadow-sm flex items-center justify-center gap-1.5 hover:-translate-y-0.5 relative overflow-hidden">
                                ...
                                <button onclick="rumikuConfirm('Langsung tayangkan post ini sekarang secara manual?', () => @this.publishPost({{ $post->id }}))" class="w-full max-w-[150px] px-4 py-2 bg-[#D0F849] text-gray-900 hover:bg-[#bceb23] border border-[#D0F849] rounded-2xl text-[11px] font-extrabold tracking-wide transition-all shadow-sm hover:shadow-md flex items-center justify-center gap-1.5 hover:-translate-y-0.5">
